...
using static ShoppingApp.Web.Models.Dtos.OrderListDto;
    ...
    public class CardController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderDto orderDto)
        {
            if (ModelState.IsValid)
            {
                ...
                //1) Kredi kartı numaras kontrolü
                //2) Eğer kart numarası geçerliyse ödemeyi al
                //3) Ödeme başarılıysa Orderı kaydet
                if (!CardNumberControl(orderDto.CarNumber))
                {
                    TempData["Message"] = Jobs.CreateMessage("Hata", "KrediKartı Numarası Hatalıdır!", "danger");
                    return View(orderDto);
                }
        ...
        [NonAction]//Action değilse yazılacak
        private async void SaveOrder(OrderDto orderDto, string userId)
        {
            ...
            order.OrderState = EnumOrderState.Unpaid;//bunu geici olarak 
        ...
        private bool CardNumberControl(string cardNumber)
        {
             ...
             * - cardNumer uzunluk kontrolü
             * - cardNumber sayılsal değer kontolü
             * - Luhn algoritması iin gerekenleri yap.             
             */
            #endregion
        ...
        private Payment PaymentProcess(OrderDto orderDto)
        {
            ...
            options.ApiKey = "sandbox-oBf05Kz1h3ZkXy6LJMQet7rjG85FcJbB";
            options.SecretKey = "sandbox-FASEqN15BySKBRWRWwVo97nzBsZeWm8V";
            ...
            CreatePaymentRequest request = new CreatePaymentRequest
            {
                ...
                Buyer = new Buyer
                {
                    ...
                    Name ="Wissen",
                    Surname = "Akademia",
                    GsmNumber = "+905557899898",
                    Email = "wissen@mail.com",
                    IdentityNumber = "74300864791",
                    RegistrationAddress = "Barbaros bulvarı Yıldız iş hanı",
                    Ip = "85.34.112.78",
                    City = "İstanbul",
                    Country = "Türkiye"
                },
                ShippingAddress = new Address
                {
                    ...
                    City = "Istanbul",
                    Country = "Turkey",
                    Description = "Barbaros bulvarı Yıldız iş hanı",
                },
            ...
            foreach (var item in orderDto.CardDto.CardItems)
            {
                ...
                basketItem.Category1 = "Genel"; // Bu bize aslında carddto içindeki productların category bililerini de doldurmamız gerektiğini hatrlattı.
