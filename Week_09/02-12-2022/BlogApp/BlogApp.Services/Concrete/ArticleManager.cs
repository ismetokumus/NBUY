...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IDataResult<ArticleDto>> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            article.UserId = 1;
            #region Açıklamalar
            //UserID şimdilik elle verildi login işlemleri yapıldımı burayı değiştireceğiz.
            //Eğer entitybase ierisinde CreatedDate iin default değer vermemiş olsaydık,böyle yapabilirdik.. bunun ikinci bir yolu da profile içinden bu değeri vermektir.
        ...
        public async Task<IDataResult<ArticleDto>> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
                ...
                var updataArticle = await _unitOfWork.Articles.UpdateAsync(article);
                await _unitOfWork.SaveAsync();
