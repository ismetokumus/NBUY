...
namespace BlogApp.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        ...
        {
            #region AÇIKLAMA
            //Burada Ef core tarafından default convention yöntemiyle kendiliğinden gerçekleşen bazı ayarları eş ile yapıyor olacağız. Bu daha profosyonel sürdürülebilir, genişletilebilir uygulamalar yapmak için tercih edilen bir yoldur.
            #endregion

            builder.HasKey(a => a.Id);//PrimaryKey
            builder.Property(a => a.Id).ValueGeneratedOnAdd();// Identity eklendikce birer birer artış

            builder.Property(a => a.Title).IsRequired(); // zorunlu (varsayılanı trueyani zorunlu)
            builder.Property(a => a.Title).HasMaxLength(100); // Max yüz karakter
            ...
            builder.Property(a=>a.SeoAutor).IsRequired();
            builder.Property(a => a.SeoAutor).HasMaxLength(50);
