    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(UserAddDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = Jobs.CreateMessage("Başarılı", $"{user.UserName} kullanıcısı başarıyla gncellendi", "success");
                return RedirectToAction("Index","User");
            }
        ...
        //ÖDEV= Roler ve kullanıcılar ile ilgili silme işlemlerinini de tamamlayın.
    }
}
