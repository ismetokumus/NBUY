namespace Proje05_Methods_Advanced
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var person in persons)//dizi içerisinde person ile sırasıyla dolaşıyor.
            {
                Console.WriteLine(person.Intro());
            }
            for (int i = 0; i < 5; i++)
            {
                Console.WriteLine(persons[i].Intro());

            }
            //Tüm kişilerin Into bilgilerini ekrana yazdırın
            Console.ReadLine(); 
