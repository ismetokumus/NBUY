...
namespace ShoppingApp.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        ...
        {
            #region RolBilgileri
            //Role bilgileri oluşturulup eklendi
            ...
            users[0].PasswordHash = passworHasher.HashPassword(users[0], "Qwe123.");
            users[1].PasswordHash = passworHasher.HashPassword(users[1], "Qwe123.");
            ...
            #region Alışveriş Sepeti ekleme
