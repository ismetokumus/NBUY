    ...
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.Email)
                .IsRequired()
                .HasMaxLength(50);
            builder.HasIndex(u=>u.Email).IsUnique(); // Bu benzersiz değer özelliği aynı email olamaz.
            ...
            builder.HasData(
                new User
                {
                    ...
                    Note = "Bu. admin kullanıcısı.",
                    PasswordHash =Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2")//qwe123 şiframizin hashlenmiş hali.
                ...
                new User
                {
                    ...
                    ModifiedByName = "InitialCreated",
                    ModifiedDate = DateTime.Now,
                    Note = "Bu. user kullanıcısı.",
                    PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a")//123qwe şiframizin hashlenmiş hali.
