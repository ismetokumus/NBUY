    ...
    public class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>()
                .HasData(
                    new Product(){Id=1, Name="Ipone 13", Desc="Güzel bir telefon", Price=19000, CategoryId=1},
                    new Product(){Id=2, Name="Dell Xside", Desc="Güzel bir bilgisayar", Price=15000, CategoryId=2},
                    new Product(){Id=3, Name="Samsung A71", Desc="Kamerası çok güel", Price=17000, CategoryId=1},
