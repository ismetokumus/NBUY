...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> Get(int categoryId)
        {
            ...
            if (category!=null)//Aranan categories bulunduysa
            {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Error, "Büyle bir kategori bulunmadı", null);
        }
        ...
        public async Task<IDataResult<CategoryListDto>> GetAll()
        {
            ...
            return new DataResult<CategoryListDto>(ResultStatus.Error, "Hiç kategori bulunmadı", null);
        }
