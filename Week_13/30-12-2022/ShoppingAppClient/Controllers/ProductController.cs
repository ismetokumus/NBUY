...
namespace ShoppingAppClient.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            //if (productViewModel.SelectedCategoryIds == null)
            //{
            ...
            if (ModelState.IsValid)
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    {
                        #region KategorileriGetirDoldur
                        var kategoriler = new List<CategoryViewModel>();
        ...
        public async Task<IActionResult> Edit(ProductViewModel productViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                using (var httpClient = new HttpClient())
                {
                    var serilaizeProduct = JsonConvert.SerializeObject(productViewModel);
                    StringContent stringContent = new StringContent(serilaizeProduct,Encoding.UTF8,"application/json");
